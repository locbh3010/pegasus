                    ...
                    <section className="container mx-auto px-4 py-20 text-center">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <p className="text-muted-foreground mb-8 text-xl md:text-2xl">
                                A modern, intuitive task management platform designed to help you
                            ...
                            <div className="grid gap-8 md:grid-cols-3">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-muted-foreground">
                                        Lightning-fast performance with an intuitive interface that
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-muted-foreground">
                                        Powerful features to help you organize, prioritize, and
