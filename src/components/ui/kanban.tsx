...
const KanbanContext = React.createContext<KanbanContextProps<Record<string, unknown>>>({
  columns: {},
  setColumns: () => {},
  getItemId: () => '',
  columnIds: [],
...
function Kanban<T>({
  ...
  return (
    <KanbanContext.Provider value={contextValue as KanbanContextProps<Record<string, unknown>>}>
      <DndContext
        sensors={sensors}
...
function KanbanColumn({ value, className, children, disabled }: KanbanColumnProps) {
  ...
  return (
    <ColumnContext.Provider
      value={{ attributes, listeners, isDragging: isColumnDragging, disabled: disabled ?? false }}
    >
      <div
...
function KanbanItem({ value, asChild = false, className, children, disabled }: KanbanItemProps) {
  ...
  return (
    <ItemContext.Provider
      value={{ listeners, isDragging: isItemDragging, disabled: disabled ?? false }}
    >
      <Comp
